<div class="relative isolate px-6 pt-14 lg:px-8 bg-cover bg-center bg-no-repeat bg-[url('https://tailframes.com/images/squares-bg.webp')] bg-[radial-gradient(ellipse_at_left,_var(--tw-gradient-stops))] from-indigo-500 via-indigo-300 to-indigo-100">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      <div class="text-center">
        ...
        <p class="mt-8 text-pretty text-lg font-medium text-indigo-200 sm:text-xl/8">Our platform offers stats, predictive tools, and tips to help you improve your Fantasy Premier League picks.</p>
