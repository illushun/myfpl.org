...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <link rel="canonical" href="https://www.myfpl.org/teams">

        <!-- Open Graph Meta Tags -->
        <meta property="og:title" content="MyFPL | Teams">
        ...
        <meta name="twitter:title" content="MyFPL | Teams">
