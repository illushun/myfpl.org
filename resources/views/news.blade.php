...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <link rel="canonical" href="https://www.myfpl.org/news">

        <!-- Open Graph Meta Tags -->
        <meta property="og:title" content="MyFPL | News">
        ...
        <meta property="og:url" content="https://www.myfpl.org/news">
        <meta property="og:type" content="website">

        <!-- Twitter Card Meta Tags -->
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:title" content="MyFPL | News">
